...
*/}}
{{- define "omar-services.imagePullSecrets" -}}
  {{/*
  ...
  */}}
  ...
  {{- if .Values.generatedImagePullSecret -}}
    {{- if .Values.generatedImagePullSecret.create -}}
      {{- $secrets = (append $secrets (.Values.generatedImagePullSecret.name | default (include "omar-services.fullname" .))) }}
    {{- end -}}
  {{- end -}}
...
{{- define "omar-services.generateImagePullSecret" }}
