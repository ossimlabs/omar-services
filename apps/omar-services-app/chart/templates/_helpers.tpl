{{- define "omar-services.imagePullSecret" }}
...
Common labels
*/}}
{{- define "omar-services.labels" -}}
omar-services.sh/chart: {{ include "omar-services.chart" . }}
{{ include "omar-services.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "omar-services.selectorLabels" -}}
app.kubernetes.io/name: {{ include "omar-services.name" . }}
...
{{- define "omar-services.pullPolicy" -}}
